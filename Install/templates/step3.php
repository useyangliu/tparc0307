      ...
      <div class="server">
        <table width="100%">
          ...
          <tr>
            ...
            <td><input type="text" name="dbname" id="dbname" value="tp_mingyu" class="input"></td>
          ...
          <tr>
          	...
          	<td colspan="2"><input style="width:18px;height:18px;" type="checkbox" name="demo" checked></td>
          </tr>
        </table>
        <!--  
		<table width="100%">
  ...
  function TestDbPwd(connect_db)
    {
        ...
        $.ajax({
            ...
            success: function(msg){			
				...
				{				    
                    $('#J_install_tip_dbpw').html('<span for="dbname" generated="true" class="tips_error" style="">请在mysql配置文件修sql-mode为NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION</span>');
				}
				else{
				    $('#dbpw').val("");
